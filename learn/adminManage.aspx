<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminManage.aspx.cs" Inherits="learn.adminMange" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <asp:Button ID="Button2" class="btn btn-lg mt-2 w-100 btn-block btn-danger" runat="server" Text="Delete User Permanently" />
                     </div>
                  </div>
               </div>
            </div>
